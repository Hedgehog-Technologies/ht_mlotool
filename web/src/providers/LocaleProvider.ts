...
const defaultLocale: Locale = {
  ...
  ui_room_dat_unk03_info: "Usually left as 0.35",
  ...
  ui_room_dat_unk13_info: "Likely a hash referring to a InteriorRoomParams (further support in a future update). Usually left blank",
  ui_room_dat_zone: "Zone",
  ui_room_dat_zone_info: "Usually left blank",
