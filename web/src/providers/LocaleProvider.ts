...
const defaultLocale: Locale = {
  ...
  ui_dt_coming_soon: "Coming Soon™...",
  ui_dt_pardon_dust: "Pardon our dust",
  ...
  ui_irp_form_error_name_exists: "Name already exists",
  ui_irp_form_error_name_too_short: "Name too short",
  ui_irp_form_error_values_exist: "[%s] already has these values",
  ui_irp_form_name: "Name",
  ui_irp_form_unk01: "Unk01",
  ui_irp_form_unk02: "Unk02",
  ui_irp_form_unk03: "Unk03",
  ui_irp_form_unk04: "Unk04",
  ui_irp_form_unk05: "Unk05",
  ui_irp_header_add_new: "Add New...",
  ui_irp_header_title: "Interior Room Params",
  ui_irp_header_search_placeholder: "Search...",
  ui_irp_table_confirm_delete_cancel: "Cancel",
  ui_irp_table_confirm_delete_confirm: "Confirm",
  ui_irp_table_confirm_delete_title: "Confirm Delete",
  ui_irp_table_header_name: "Name",
  ui_irp_table_header_name_tooltip: "Name of the configuration",
  ui_irp_table_header_unk01: "Unk01",
  ui_irp_table_header_unk01_tooltip: "(Wetness) How processed audio will be. Range: 0.0 - 1.0",
  ui_irp_table_header_unk02: "Unk02",
  ui_irp_table_header_unk02_tooltip: "(Visibility) Volume level of audio. Range: 0.0 - 1.0",
  ui_irp_table_header_unk03: "Unk03",
  ui_irp_table_header_unk03_tooltip: "(LowPassFilter) Filter to remove high-frequency sounds.",
  ui_irp_table_header_unk04: "Unk04",
  ui_irp_table_header_unk04_tooltip: "(PreDelay) Time between end of initial sound and beginning of first reflection.",
  ui_irp_table_header_unk05: "Unk05",
  ui_irp_table_header_unk05_tooltip: "(Hold) How long to keep sound effect around once audio is finished.",
  ui_irp_toggle_edit_mode: "Toggle Edit Mode",
...
interface LocaleState {
  localeState: Locale;
  locale: (key: string, values?: string[]) => string;
};
...
export const useLocale = create<LocaleState>((_, get) => ({
  ...
  locale: (key, values?) => {
    let locale = get().localeState[key] ?? key;
    let idx = 0;

    while (locale.includes("%s") && idx < (values?.length ?? -1)) {
      locale = locale.replace("%s", values![idx++]);
    }
