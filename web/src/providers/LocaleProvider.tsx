...
const defaultLocale: Locale = {
  ...
  ui_room_dat_ambient_zone: "Ambient Zone",
  ui_room_dat_ambient_zone_info: "A hash referring to an AmbientZone object. Usually left blank",
  ui_room_dat_distance_from_portal_fade_distance: "Distance From Portal Fade Distance",
  ui_room_dat_distance_from_portal_fade_distance_info: "Usually left as 50",
  ui_room_dat_distance_from_portal_for_occlusion: "Distance From Portal For Occlusion",
  ui_room_dat_distance_from_portal_for_occlusion_info: "Usually left as 0",
  ui_room_dat_exterior_audibility: "Exterior Audibility",
  ui_room_dat_exterior_audibility_info: "Usually left as 0",
  ui_room_dat_flags: "Flags",
  ui_room_dat_flags_info: "Usually left as 0xAAAAAAAA",
  ui_room_dat_interior_type: "Interior Type",
  ui_room_dat_interior_type_info: "Usually left as 0",
  ui_room_dat_interior_walla_sound_set: "Interior Walla Sound Set",
  ui_room_dat_interior_walla_sound_set_info: "Usually left as hash_D4855127",
  ui_room_dat_nonmarked_portal_occlusion: "Nonmarked Portal Occlusion",
  ui_room_dat_nonmarked_portal_occlusion_info: "Usually left as 0.7",
  ui_room_dat_rain_type: "Rain Type",
  ui_room_dat_rain_type_info: "Usually left as 0",
  ui_room_dat_reverb_large: "Reverb Large",
  ui_room_dat_reverb_large_info: "Set level of echo for the currently selected room. Range 0.0 - 1.0",
  ui_room_dat_reverb_medium: "Reverb Medium",
  ui_room_dat_reverb_medium_info: "Set level of reverb for the currently selected room. Range: 0.0 - 1.0",
  ui_room_dat_reverb_small: "Reverb Small",
  ui_room_dat_reverb_small_info: "Usually left as 0.35. Range: 0.0 - 1.0",
  ui_room_dat_room_occlusion_damping: "Room Occlusion Damping",
  ui_room_dat_room_occlusion_damping_info: "Usually left as 0",
  ui_room_dat_room_tone_sound: "Room Tone Sound",
  ui_room_dat_room_tone_sound_info: "Room sounds. Usually left as null_sound",
  ui_room_dat_settings: "Dat151 Settings",
  ui_room_dat_weapon_metrics: "Weapon Metrics",
  ui_room_dat_weapon_metrics_info: "A hash referring to an InteriorRoomParams object (further support in a future update). Used for weapon audio occlusion. Usually left blank",
