...
const defaultLocale: Locale = {
  ...
  ui_room_dat_echo: "Reverb Large",
  ui_room_dat_echo_info: "Set level of echo for the currently selected room. Range 0.0 - 1.0",
  ui_room_dat_flags: "Flags",
  ui_room_dat_flags_info: "Usually left as 0xAAAAAAAA",
  ui_room_dat_reverb: "Reverb Medium",
  ui_room_dat_reverb_info: "Set level of reverb for the currently selected room. Range: 0.0 - 1.0",
  ui_room_dat_sound: "Room Tone Sound",
  ui_room_dat_sound_info: "Room sounds. Usually left as null_sound",
  ui_room_dat_soundset: "Interior Walla Sound Set",
  ui_room_dat_soundset_info: "Usually left as hash_D4855127",
  ui_room_dat_unk02: "Interior Type",
  ui_room_dat_unk02_info: "Usually left as 0",
  ui_room_dat_unk03: "Reverb Small",
  ui_room_dat_unk03_info: "Usually left as 0.35. Range: 0.0 - 1.0",
  ui_room_dat_unk07: "Rain Type",
  ui_room_dat_unk07_info: "Usually left as 0",
  ui_room_dat_unk08: "Exterior Audibility",
  ui_room_dat_unk08_info: "Usually left as 0",
  ui_room_dat_unk09: "Room Occlusion Damping",
  ui_room_dat_unk09_info: "Usually left as 0",
  ui_room_dat_unk10: "Nonmarked Portal Occlusion",
  ui_room_dat_unk10_info: "Usually left as 0.7",
  ui_room_dat_unk11: "Distance From Portal For Occlusion",
  ui_room_dat_unk11_info: "Usually left as 0",
  ui_room_dat_unk12: "Distance From Portal Fade Distance",
  ui_room_dat_unk12_info: "Usually left as 50",
  ui_room_dat_unk13: "Weapon Metrics",
  ui_room_dat_unk13_info: "A hash referring to an InteriorRoomParams object (further support in a future update). Used for weapon audio occlusion. Usually left blank",
  ui_room_dat_zone: "Ambient Zone",
  ui_room_dat_zone_info: "A hash referring to an AmbientZone object. Usually left blank",
